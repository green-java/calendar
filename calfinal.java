...
String smonth[]={"JANUARY","FEBRAURY","MARCH","APRIL","MAY","JUNE","JULY","AUGUST","SEPTEMBER","OCTOBER","NOVEMBER","DECEMBER"};
...
public void next_month()
{
    ...
    switch(ii)
    {
        case 0:
          total=31;
          c.set(int_year,Calendar.JANUARY,1);
          break;
        case 1:
          total=28;
          c.set(int_year,Calendar.FEBRUARY,1);
          break;
        case 2:
          total=31;
          c.set(int_year,Calendar.MARCH,1);
          break;
        case 3:
            total=30;
            c.set(int_year,Calendar.APRIL,1);
            break;
        case 4:
            total=31;
            c.set(int_year,Calendar.MAY,1);
            break;
        case 5:
            total=30;
            c.set(int_year,Calendar.JUNE,1);
            break;
        case 6:
            total=31;
            c.set(int_year,Calendar.JULY,1);
            break;
        case 7:
           total=31;
           c.set(int_year,Calendar.AUGUST,1);
           break;
        case 8:
            total=30;
            c.set(int_year,Calendar.SEPTEMBER,1);
           break;
        case 9:
            total=31;
            c.set(int_year,Calendar.OCTOBER,1);
             break;
        case 10:
             total=30;
            c.set(int_year,Calendar.NOVEMBER,1);
            break;
        case 11:
            total=31;
